    ...
    public static ArrayList<Pair<Integer, Integer>> convertStringToKeyCode(ArrayList<String> inputList) {
        ...
        for (String s : inputList) {
            switch (s) {
                ...
                case "BACK_QUOTE" -> keyCodeList.add(new Pair<>(VK_BACK_QUOTE, null));
                ...
                case "MINUS" -> keyCodeList.add(new Pair<>(VK_MINUS, null));
                case "EQUALS" -> keyCodeList.add(new Pair<>(VK_EQUALS, null));
                case "APOSTROPHE" -> keyCodeList.add(new Pair<>(VK_BACK_QUOTE, VK_SHIFT));
                case "EXCLAMATION_MARK" -> keyCodeList.add(new Pair<>(VK_EXCLAMATION_MARK, null));
                case "AT" -> keyCodeList.add(new Pair<>(VK_AT, null));
                case "NUMBER_SIGN" -> keyCodeList.add(new Pair<>(VK_NUMBER_SIGN, null));
                case "DOLLAR" -> keyCodeList.add(new Pair<>(VK_DOLLAR, null));
                case "PERCENT" -> keyCodeList.add(new Pair<>(VK_5, VK_SHIFT));
                case "CIRCUMFLEX" -> keyCodeList.add(new Pair<>(VK_CIRCUMFLEX, null));
                case "AMPERSAND" -> keyCodeList.add(new Pair<>(VK_AMPERSAND, null));
                case "ASTERISK" -> keyCodeList.add(new Pair<>(VK_ASTERISK, null));
                case "LEFT_PARENTHESIS" -> keyCodeList.add(new Pair<>(VK_9, VK_SHIFT));
                case "RIGHT_PARENTHESIS" -> keyCodeList.add(new Pair<>(VK_RIGHT_PARENTHESIS, null));
                case "UNDERSCORE" -> keyCodeList.add(new Pair<>(VK_UNDERSCORE, null));
                case "PLUS" -> keyCodeList.add(new Pair<>(VK_PLUS, null));
                case "TAB" -> keyCodeList.add(new Pair<>(VK_TAB, null));
                case "ENTER" -> keyCodeList.add(new Pair<>(VK_ENTER, null));
                case "OPEN_BRACKET" -> keyCodeList.add(new Pair<>(VK_OPEN_BRACKET, null));
                case "CLOSE_BRACKET" -> keyCodeList.add(new Pair<>(VK_CLOSE_BRACKET, null));
                case "BACK_SLASH" -> keyCodeList.add(new Pair<>(VK_BACK_SLASH, null));
                case "OPEN_BRACE" -> keyCodeList.add(new Pair<>(VK_OPEN_BRACKET, VK_SHIFT));
                case "CLOSE_BRACE" -> keyCodeList.add(new Pair<>(VK_CLOSE_BRACKET, VK_SHIFT));
                case "LINE" -> keyCodeList.add(new Pair<>(VK_BACK_SLASH, VK_SHIFT));
                case "COLON" -> keyCodeList.add(new Pair<>(VK_SEMICOLON, VK_SHIFT));
                case "SEMICOLON" -> keyCodeList.add(new Pair<>(VK_SEMICOLON, null));
                case "QUOTE" -> keyCodeList.add(new Pair<>(VK_QUOTE, null));
                case "DOUBLEQUOTE" -> keyCodeList.add(new Pair<>(VK_QUOTE, VK_SHIFT));
                case "COMMA" -> keyCodeList.add(new Pair<>(VK_COMMA, null));
                case "LEFT_ANGLE_BRACKET" -> keyCodeList.add(new Pair<>(VK_COMMA, VK_SHIFT));
                case "PERIOD" -> keyCodeList.add(new Pair<>(VK_PERIOD, null));
                case "RIGHT_ANGLE_BRACKET" -> keyCodeList.add(new Pair<>(VK_PERIOD, VK_SHIFT));
                case "SLASH" -> keyCodeList.add(new Pair<>(VK_SLASH, null));
                case "QUESTION" -> keyCodeList.add(new Pair<>(VK_SLASH, VK_SHIFT));
